    ...
    public class AuthenticationService : IAuthenticationService
    {
        ...
        private static readonly List<InternalUserData> _users = new List<InternalUserData>()
        {
            ...
            "hMaLizwzOQ5LeOnMuj+C6W75Zl5CXXYbwDSHWW9ZOXc=", new string[] { }),
             new InternalUserData("Busara", "john@company.com",
            "PS6mw2XFW+RCaSJGMtviPfxZf8L8C/P+Yuz1DlPA2EE=", new string[] {"Administrators" }),
            
        };
        public string busara(string username, string clearTextPassword)
        {
            return CalculateHash(clearTextPassword, username);
        }
