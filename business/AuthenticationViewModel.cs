...
namespace business
{
    ...
    public class AuthenticationViewModel : IViewModel, INotifyPropertyChanged
    {
        ...
        private readonly DelegateCommand _visCommand;
        ...
        public AuthenticationViewModel(IAuthenticationService authenticationService)
        {
            ...
            _visCommand = new DelegateCommand(vis, CanVis);
            ...
            get
            {
                if (IsAuthenticated)
                    return string.Format("Signed in as {0}. {1}",
                          ...
                          Thread.CurrentPrincipal.IsInRole("Administrators") ? "(staf member)"
                              : "(Student)");
        ...
        public DelegateCommand visCommand { get { return _visCommand; } }
        ...
        private void Login(object parameter)
        {
            ...
            try
            {
                ...
                _visCommand.RaiseCanExecuteChanged();
        ...
        private void vis(object parameter)
        {
            CustomPrincipal customPrincipal = Thread.CurrentPrincipal as CustomPrincipal;
            if (customPrincipal != null)
            {
        ...
        private bool CanVis(object parameter)
        {
            return !IsAuthenticated;
        }
